...
public class Nemesis extends AbstractMonster {
    ...
    private final Bone eye1;
    private final Bone eye2;
    private final Bone eye3;

    public Nemesis() {
        super(NAME, "Nemesis", 32, 5.0F, -10.0F, 350.0F, 440.0F, null, 0.0F, 0.0F);
    ...
    public void takeTurn() {
        switch (this.nextMove) {
            case 1:
                ...
                AbstractDungeon.actionManager.addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(0), AttackEffect.SLASH_HEAVY));
                this.rollMove();
                break;
            case 2:
            ...
            case 3:
                ...
                if (!AbstractDungeon.player.powers.isEmpty()) {
                    String toRemove = AbstractDungeon.player.powers.get(MathUtils.random(0, AbstractDungeon.player.powers.size() - 1)).ID;
