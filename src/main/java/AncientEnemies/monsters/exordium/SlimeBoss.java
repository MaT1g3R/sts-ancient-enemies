...
public class SlimeBoss extends AbstractMonster {
    ...
    public SlimeBoss() {
        super(NAME, "SlimeBoss", 150, 0.0F, -30.0F, 400.0F, 350.0F, (String)null, 0.0F, 28.0F);
    ...
    public void takeTurn() {
        switch (this.nextMove) {
            case 1:
                ...
                this.setMove(STICKY_NAME, (byte)4, Intent.ATTACK_DEBUFF, ((DamageInfo)this.damage.get(0)).base);
                break;
            case 2:
                this.playSfx();
