...
public class FuzzyLouseDefensive extends AbstractMonster {
    ...
    public FuzzyLouseDefensive(float x, float y) {
        super(NAME, "FuzzyLouseDefensive", MathUtils.random(11, 17), 0.0F, -5.0F, 180.0F, 140.0F, null, x, y);
